...
import io.hummingbird.common.dto.HttpClientResult;
...
public class HttpClientUtils {
    ...
    public static HttpClientResult doPostWithDefaultHead(String url, Map<String, String> params) throws Exception {
